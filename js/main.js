...
const channels = [
    { id: 'mRryrODqQcw', name: 'Bem-Vindo' },
    { id: 'o5H2LYuHM1I', name: 'Fundamentos de Programaçao' },
    { id: 'ebEhe5NBUw4', name: 'Como instalar o JDK e o Intelij no Windowa' },
    { id: '-uwh4GWJBqc', name: 'Instalando o Java JDK e IDE no McOs' },
    { id: 'QO5ItC3KqJg', name: 'Primeiro programa Java' },
    { id: 'BLMu7ebMC1A', name: 'Programação dinâmica com variáveis' },
    { id: '2P1EHfUsthc', name: 'Erros na programação' },
    { id: 'xO2_XL7k29k', name: 'Funções' },
    { id: 'E0VeajoiNrY', name: 'Argumentos' },
    { id: 'uM0mvhCpVWg', name: 'Projeto 1 e condições' },
    { id: '9xTqj779eP0', name: 'Loops' },
    { id: 'uK_L9Ikevgc', name: 'Imports e packages' },
    { id: 'j34V7iUSI2M', name: 'Java Interativo' },
    { id: '4le-A7To79g', name: 'Tipos não primitivos' },
    { id: '_xVfu5dBUEI', name: 'Escopo' },
    { id: 'BV0s62wjR5s', name: 'Variável imutável' },
    { id: 'Z4tlBCVNtfY', name: 'Visibilidade' },
    { id: 'Xis_sR9jLdI', name: 'Revisão primitivo' },
    { id: '-dEvEiXxxho', name: 'Casting' },
    { id: 'Dkw2e8j6nhY', name: 'Manipulando Strings' },
    { id: 'jsqztViUJlE', name: 'Comparando Strings' },
    { id: 'cLC5sSJ5Ds0', name: 'Orientação a Objetos' },
    { id: 'l9S20F0kIK4', name: 'OPP métodos e propriedades' },
    { id: 'JgaI3-n6YmA', name: 'OPP getters e setters' },
    { id: 'Ed0y7Lh7eK8', name: 'Arrays' },
    { id: 'Cqbw54nyXxE', name: 'Construtor' },
    { id: 'JC2064pf3o4', name: 'Coleção. Lista. Arraylista' },
    { id: 'zW3b3yIztyI', name: 'Algoritmos' },
    { id: 'uxeXvdMtMPs', name: 'Ordenação' },
    { id: '4LYOaewfjhU', name: 'Comparando arrays' },
    { id: 'B8YHDRKgmMI', name: 'Preenchendo arrays' },
    { id: 'c0nEVgU7G_w', name: 'Mátodos do arraylist' },
    { id: 'RR6S5oo04vs', name: 'Ordenação e foreach de objetos' },
    { id: '9JSyVl3ruwk', name: 'Sobrecarga de métodos' },
    { id: 'ZzpQShxOKns', name: 'To String' },
    { id: 'NPJBmZfZmYI', name: 'Hash code e equals' },
    { id: '-BTVNxtn828', name: 'Static' },
    { id: '_lNxxTGuAJc', name: 'Projeto resumão (versão 1)' },
    { id: 'OW9PeY1-L-I', name: 'Projeto resumão (versão 2)' },
    { id: 'tpqAsh1ewXw', name: 'Projeto resumão (versão 3)' }
];
